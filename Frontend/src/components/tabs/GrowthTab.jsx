  ...
  return (
    <div className="grid lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-4">
        {showCharts && (
          <>
            <MetricChart title="Weight (lbs)" color="#10b981" babyData={weightBaby} percData={weightPerc} yLabel="lbs" xLabel={xLabel} />
            <MetricChart title="Height (in)" color="#3b82f6" babyData={heightBaby} percData={heightPerc} yLabel="in" xLabel={xLabel} />
            <MetricChart title="Head circumference (in)" color="#a855f7" babyData={headBaby} percData={headPerc} yLabel="in" xLabel={xLabel} />
          </>
        )}
