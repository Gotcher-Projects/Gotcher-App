              ...
              {editingId === e.id ? (
                ...
                <div className="flex min-h-[220px]">
                  ...
                  <div className="flex-1 p-4 flex flex-col justify-between min-w-0">
                    <div>
                      <span className="text-xs font-medium bg-fuchsia-50 text-fuchsia-700 px-2 py-0.5 rounded-full border border-fuchsia-100">
                        Week {e.week}
                      </span>
                      <h4 className="text-lg font-bold text-slate-800 mt-2 mb-1 leading-snug">{e.title}</h4>
                      <p className="text-xs text-slate-400 mb-2">{formatEntryDate(e.entry_date || e.date)}</p>
                      {e.story && (
                        <p className="text-sm text-slate-600 leading-relaxed whitespace-pre-wrap line-clamp-5">{e.story}</p>
                      )}
                    </div>
                ...
                <CardContent className="p-5 pb-3">
                  ...
                  <p className="text-xs text-slate-400">{formatEntryDate(e.entry_date || e.date)}</p>
                </CardContent>
                {e.image_url && (
                ...
                <CardContent className="p-5 pt-3">
                  {e.story && (
                    <p className="text-base text-slate-600 leading-relaxed whitespace-pre-wrap mb-4">{e.story}</p>
                  )}
