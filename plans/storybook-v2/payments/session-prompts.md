...
Plan: plans/storybook-v2/payments/s0-planning.md
...
6. ~~Confirm Lulu purchase model (Lulu-hosted checkout, no Stripe on our side)~~ **Resolved 2026-07-01: Lulu Print API checkout is external — we collect via Stripe; print depends on this Payments work. See `plans/storybook-v2/handoffs/`.**
7. Decide cancellation UX (Stripe billing portal vs. manual)

Read plans/storybook-v2/payments/s0-planning.md fully before starting. Do not write any code this session.

---

## S1 — Stripe Backend Integration
Branch: payments-s1
Plan: plans/storybook-v2/payments/s1-stripe-backend.md
...
Read plans/storybook-v2/payments/s1-stripe-backend.md fully before starting.

---

## S2 — Upgrade Flow (Frontend)
Branch: payments-s2
Plan: plans/storybook-v2/payments/s2-upgrade-flow.md
...
Read plans/storybook-v2/payments/s2-upgrade-flow.md fully before starting.
